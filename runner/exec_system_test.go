...
func TestNewRunner(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "it should failed to create runner when pulsar is failed to connect",
			args: args{
				pulsarUrl:    "pulsar://fakeip:6550",
				logTopic:     "system-test-new-log4",
				inputTopics:  "system-test-new-input4",
				subscription: "system-test-new-sub4",
				outputTopic:  "system-test-new-output4",
			},
			wantErr: true,
		},
		{
			...
			args: args{
				...
				inputTopics:  "system-test-new-input5",
		...
		},
		{
			...
			args: args{
				...
				inputTopics:  "",
				subscription: "system-test-new-sub6",
		...
		},
		{
			...
			args: args{
				pulsarUrl:    pulsarUrl,
				logTopic:     "system-test-new-log7",
				inputTopics:  "system-test-new-input7",
				subscription: "",
				outputTopic:  "system-test-new-output7",
			},
			wantErr: true,
		},
	}
